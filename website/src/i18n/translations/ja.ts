export default {
  ...
  'features.completions.title': 'シェル補完',
  'features.completions.desc': 'bash、zsh、fishでコマンド、フラグ、プロファイル名をタブ補完。',
  'features.name.title': '名前でキル',
  'features.name.desc': '正規表現対応でプロセス名を指定。一括キルから特定プロセスを除外可能。',
  'features.hook.title': 'キル後フック',
  'features.hook.desc': 'キル後に自動でコマンドを実行 — サーバー再起動、ビルド開始、チーム通知。',
  'features.check.title': 'ポート空き確認',
  'features.check.desc':
    'ポートの空き状況を確認、次の利用可能なポートを検索。CIスクリプトや自動化に最適。',
  'demos.tab.profiles': 'プロファイル',
  'stats.downloads': 'npm ダウンロード',
  'stats.stars': 'GitHub スター',
  'stats.deps': '依存関係',
  'stats.platforms': 'プラットフォーム',
  'stats.tests': 'テスト合格',
  'stats.languages': '言語対応',
  'comparison.heading': 'もう',
  'comparison.heading.accent': 'PID推測は不要',
  'comparison.subtitle': '旧来の方法は面倒。slayなら1コマンド。',
  'comparison.old': '旧来の方法',
  'comparison.new': 'slayの方法',
