export default {
  ...
  'demos.subtitle': 'Пятнадцать способов уничтожить.',
  ...
  'stats.deps': 'Зависимостей',
  'stats.platforms': 'Платформы',
  'stats.tests': 'Тестов Пройдено',
  'stats.languages': 'Языков',
  'comparison.heading': 'Хватит',
  'comparison.heading.accent': 'угадывать PID',
  'comparison.subtitle': 'Старый способ мучителен. С slay — одна команда.',
  'comparison.old': 'Старый способ',
  'comparison.new': 'Способ slay',
